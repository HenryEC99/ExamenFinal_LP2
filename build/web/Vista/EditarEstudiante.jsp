                ...
                <table  class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="f_direccion" value="<% out.println(estudiante.getCodigo()); %>" maxlength="12" size="12" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" class="text-center">
                                ...
                                <a class="btn btn-success" href="Controlador?f_accion=listarestudiante">Regresar</a>
