                ...
                <table  class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="f_estado" value="<% out.println(matricula.getEstado()); %>" maxlength="8" size="8" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="f_idestudiante" value="<% out.println(matricula.getIdestudiante()); %>" maxlength="1" size="2" /></td>
                        </tr>
                        <tr>
                            <td class="text-right">Idcarrera</td>
                            <td><input class="form-control" type="text" name="f_idcarrera" value="<% out.println(matricula.getIdcarrera()); %>" maxlength="1" size="2" /></td>
                        </tr>
                        <tr>
